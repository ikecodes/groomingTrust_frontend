...
export const programmes = [
  {
    ...
    name: "health",
    slug: "health",
    icon: <MdHealthAndSafety size={100} color='#C386C0' />,
    description:
  ...
  },
  {
    ...
    name: "education",
    slug: "education",
    icon: <MdSchool size={100} color='#C386C0' />,
    description:
  ...
  },
  {
    ...
    icon: <GiLovers size={100} color='#C386C0' />,
    description:
  ...
  {
    id: 4,
    name: "enterprise and community development",
    slug: "enterprise-and-community-development",
    icon: <AiTwotonePieChart size={100} color='#C386C0' />,
    description:
  ...
  },
  {
    ...
    icon: <FaChartLine size={100} color='#C386C0' />,
    description:
