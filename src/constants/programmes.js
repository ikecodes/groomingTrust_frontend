...
export const programmes = [
  {
    ...
    name: "health",
    slug: "health",
    icon: <MdHealthAndSafety size={40} color='#C386C0' />,
    description:
  ...
  },
  {
    ...
    name: "education",
    slug: "education",
    icon: <MdSchool size={40} color='#C386C0' />,
    description:
  ...
  },
  {
    ...
    icon: <GiLovers size={40} color='#C386C0' />,
    description:
  ...
  },
  {
    ...
    icon: <AiTwotonePieChart size={40} color='#C386C0' />,
    description:
  ...
  },
  {
    ...
    icon: <FaChartLine size={40} color='#C386C0' />,
    description:
